...
public class UserDaoImpl implements UserDao {
	...
	private static final String SELECT_BY_USERID_PASSWORD = "SELECT user_id, password, user_name, postcode,"
			+ " address, email, job, birthday FROM user_account_SPRING3 WHERE user_id = ? AND password = ?";

	private static final String INSERT = "INSERT INTO user_account_SPRING3 (user_id, user_name, password, postcode, address, email, job, birthday)"
